    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClick(new StudentAdapter.OnItemClick() {
            ...
            public void clickName(String name) {
                Toast.makeText(RecyclerViewActivity.this, name, Toast.LENGTH_SHORT).show();
            }

            @Override
            public void clickAge(String age) {
                Toast.makeText(RecyclerViewActivity.this, age, Toast.LENGTH_SHORT).show();
            }

            @Override
            public void clickItem() {
                Toast.makeText(RecyclerViewActivity.this, "Đây là item", Toast.LENGTH_SHORT).show();
            }
        });
    }
